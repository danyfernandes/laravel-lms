<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-white bg-primary hover:text-black transition duration-150 ease-in-out">
    ...
    <div :class="{ 'block': open, 'hidden': !open }"
        class="hidden space-y-2 mt-4 z-10 absolute bg-white w-full sm:hidden">
        <div>
            <x-responsive-nav-link :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')">
                <p class="text-center">{{ __('Admin') }}</p>
            </x-responsive-nav-link>
        </div>

        <div>
            <x-responsive-nav-link :href="route('admin.users')" :active="request()->routeIs('admin.users')">
                <p class="text-center">{{ __('Users') }}</p>
            </x-responsive-nav-link>
        </div>
        ...
        <div class="pt-4 space-y-2 border-t border-gray-200">
            ...
            <div class="border-b border-gray-200">
                <x-responsive-nav-link :href="route('profile.edit')">
                    <p class="text-center">{{ __('Profile') }}</p>
                </x-responsive-nav-link>
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <x-responsive-nav-link :href="route('logout')"
                        onclick="event.preventDefault();
                                      this.closest('form').submit();">
                        <p class="text-center">{{ __('Log Out') }}</p>
                    </x-responsive-nav-link>
                </form>
            </div>
        </div>
